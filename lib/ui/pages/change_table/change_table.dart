...
class ChangeTableKey extends StatefulWidget {
  final VoidCallback? onClose;
  final TableDetailCubit? tableDetailCubit;
  final HomeCubit homeCubit;
  const ChangeTableKey(this.tableDetailCubit, this.homeCubit,
      {super.key, this.onClose});

  @override
  State<ChangeTableKey> createState() => _ChangeTableKeyState();
}

class _ChangeTableKeyState extends State<ChangeTableKey> {
                        ...
                        children: [
                                  ...
                                  onTap: () {
                                    if (!_choose) {
                                      if (_fromTable.text != null &&
                                          _fromTable.text != '') {
                                        _fromTable.text = _fromTable.text
                                            .substring(
                                      ...
                                      if (_toTable.text != null &&
                                          _toTable.text != '') {
                                        _toTable.text = _toTable.text.substring(
                                            0, _toTable.text.length - 1);
                                      }
                                    }
                                    setState(() {});
                                  },
                          ...
                          Expanded(
                            ...
                            children: [
                              ...
                              CustomMaterialButton(
                                  onTap: () {
                                    widget.tableDetailCubit?.changeTable(
                                        tableIdFrom: _fromTable.text,
                                        tableIdTo: _toTable.text);
